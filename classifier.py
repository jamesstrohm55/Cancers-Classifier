...
# Drop colums with 'id' and 'Unnamed' because they are not useful for classification 
#Replace M (Malignant) with 1 and B (Benign) with 0
# and separate the target variable from the features
